...
eval dfx canister --no-wallet call token newStorageCanister "'($ALICE_PUBLIC_KEY)'"
eval dfx canister --no-wallet call token getStoreCanister
STOREID=$(dfx canister --no-wallet call token getStoreCanister)
STOREID=${STOREID:5:39}
echo == STOREID ==
echo $STOREID
STOREIDRAW=${STOREID:11:27}
echo == STOREIDRAW ==
echo $STOREIDRAW
eval dfx canister --no-wallet call $STOREIDRAW setTokenCanisterId "'($TOKENID)'"
...
echo == all History
echo
eval dfx canister --no-wallet call $STOREIDRAW allHistory
